  ...
  <link rel="stylesheet" href="/css/mentorship_mobile.css">
   ...
   <div id="content" class="mentorship-program">
      <div class="content mentorship-program--content">
        <header class="mentorship-program--header">
          <h1>Acupuncture Mentorship Program</h1>
          <p>Build your acupuncture business. Elevate your level of professionalism and find your inner healer.</p>
        </header>

        <section>
          <p>The Acupuncture Mentorship Program is a casual and intimate learning environment where you will learn the practice management skills you need to get your acupuncture business thriving from day one. With one-on-one meetings and individualized planning, you will learn tips and tricks that were not taught in school. This program will nurture the soul of a new acupuncturist. Together, we will find out what kind of healer you want to be!</p>
        </section>

        <section class="alt">
          <h1>What Will I gain from this Mentorship Program?</h1>
          ...
          <ul>
            ...
            <li>networking</li>
            <li>insurance</li>
            <li>finance, banking, student loans</li>
            <li>legal issues</li>
            <li>HIPAA</li>
          ...
          <ul>
            <li>what kind of acupuncturist are you?</li>
            <li>specializing (fertility, pain, pediatrics, etc)</li>
            <li>how and where to practice</li>
            <li>how to find your ideal workspace</li>
            <li>self-care</li>
          </ul>

          <aside>
            <p>Curriculum content matter will change to focus on what the students need and want to know most. Content requests and questions are not only welcome, but encouraged!</p>
          </aside>
        </section>
        ...
        <section>
          ...
          <p>You must be motivated, self-driven, and invested in creating a strong acupuncture practice. This program will present a lot of information, but ultimately you will only gain what you invest.</p>
